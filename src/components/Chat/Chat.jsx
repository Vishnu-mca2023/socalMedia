      ...
      <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
        <div className="bg-white dark:bg-gray-800 text-gray-900 dark:text-white rounded-lg w-full max-w-md p-6 border border-gray-300 dark:border-gray-700">
          <div className="flex justify-between items-center mb-4">
            ...
            <button onClick={() => setShowCreateGroup(false)} className="text-gray-600 dark:text-gray-300"><X /></button>
          </div>
          <input
            className="w-full mb-2 px-3 py-2 border rounded bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white border-gray-300 dark:border-gray-600"
          ...
          <div className="max-h-40 overflow-y-auto mb-4">
            {searchResults.map((u) => (
              <div
                ...
                className="cursor-pointer p-2 hover:bg-blue-100 dark:hover:bg-gray-700 rounded"
              >
          ...
          <div className="flex justify-end gap-2">
            <button onClick={() => setShowCreateGroup(false)} className="text-gray-600 dark:text-gray-300">Cancel</button>
            <button
              onClick={createGroup}
              disabled={!groupName.trim() || selectedUsers.length === 0}
              className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 disabled:bg-gray-300 dark:disabled:bg-gray-600"
            >
              Create
            </button>
          </div>
